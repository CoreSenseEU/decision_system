...
class OrderCopelandNode(Node):
    def __init__(self):
        super().__init__('order_copeland_node')
        self.get_logger().info('Starting ORDER node with policy: order_copeland')
