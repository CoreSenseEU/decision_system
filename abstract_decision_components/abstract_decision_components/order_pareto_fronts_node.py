...
class OrderParetoFrontsNode(Node):
    def __init__(self):
        super().__init__('order_pareto_fronts_node')
        self.get_logger().info('Starting ORDER node with policy: order_pareto_fronts')
