#ifndef KRR_BT_CPP__ASSEMBLE_DECISION_HEURISTIC_BT_ACTION_HPP_
#define KRR_BT_CPP__ASSEMBLE_DECISION_HEURISTIC_BT_ACTION_HPP_
...
// TODO: Possibly this is because the "AssembleDecisionHeuristic" node uses a different definition,
// so it has already overwritten the standard one or something?
#include "krr_btcpp_ros2/convert_from_string.hpp"
//
#include "decision_msgs/action/assemble_decision_heuristic.hpp"
// #include "decision_msgs/msg/gap.hpp"
// #include "decision_msgs/msg/alternative_array.hpp"


class AssembleDecisionHeuristicAction : public BT::RosActionNode<decision_msgs::action::AssembleDecisionHeuristic>
{
public:
  explicit AssembleDecisionHeuristicAction(const std::string& name, const BT::NodeConfig& config,
               const BT::RosNodeParams& params)
    : BT::RosActionNode<decision_msgs::action::AssembleDecisionHeuristic>(name, config, params)
  {}
  ...
  {    
    return providedBasicPorts({ 
        ...
        BT::OutputPort(
            "xml",
            "An absolute path to the heuristic behavior tree XML file."),
        BT::OutputPort<bool>(
            "yaml",
