#ifndef KRR_BT_CPP__GET_ALTERNATIVES_BT_ACTION_HPP_
#define KRR_BT_CPP__GET_ALTERNATIVES_BT_ACTION_HPP_
...
#include "decision_msgs/action/get_alternatives.hpp"
#include "decision_msgs/msg/gap.hpp"
#include "decision_msgs/msg/alternative_array.hpp"


class GetAlternativesAction : public BT::RosActionNode<decision_msgs::action::GetAlternatives>
{
public:
  explicit GetAlternativesAction(const std::string& name, const BT::NodeConfig& config,
               const BT::RosNodeParams& params)
    : BT::RosActionNode<decision_msgs::action::GetAlternatives>(name, config, params)
  {}
  ...
  {    
    return providedBasicPorts({ 
        ...
        BT::InputPort<int16_t>(
            "max_matches",
            "The maximum number of desired matches, or -1 to collect all matches."),
        BT::OutputPort<decision_msgs::msg::AlternativeArray>(
            "alternatives",
            "An array of unique alternatives matching one or more templates"),
        });
  }
