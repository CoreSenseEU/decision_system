#ifndef KRR_BT_CPP__UPDATE_ALTERNATIVES_BT_ACTION_HPP_
#define KRR_BT_CPP__UPDATE_ALTERNATIVES_BT_ACTION_HPP_
...
#include "decision_msgs/action/update_alternatives.hpp"
#include "decision_msgs/msg/alternative_array.hpp"


class UpdateAlternativesAction : public BT::RosActionNode<decision_msgs::action::UpdateAlternatives>
{
public:
  explicit UpdateAlternativesAction(const std::string& name, const BT::NodeConfig& config,
               const BT::RosNodeParams& params)
    : BT::RosActionNode<decision_msgs::action::UpdateAlternatives>(name, config, params)
  {}
  ...
  {    
    return providedBasicPorts({ 
        ...
        BT::InputPort<decision_msgs::msg::AlternativeArray>(
            "previous_choice", "",
            "Any alternatives taken in the previous iteration (if there was one)."),
        BT::BidirectionalPort<decision_msgs::msg::AlternativeArray>(
            "choice_set", "",
