#ifndef KRR_BT_CPP__UPDATE_CUES_BT_ACTION_HPP_
#define KRR_BT_CPP__UPDATE_CUES_BT_ACTION_HPP_
...
#include "decision_msgs/action/update_cues.hpp"
#include "decision_msgs/msg/cue_array.hpp"


class UpdateCuesAction : public BT::RosActionNode<decision_msgs::action::UpdateCues>
{
public:
  explicit UpdateCuesAction(const std::string& name, const BT::NodeConfig& config,
               const BT::RosNodeParams& params)
    : BT::RosActionNode<decision_msgs::action::UpdateCues>(name, config, params)
  {}
  ...
  {    
    return providedBasicPorts({ 
        ...
        BT::BidirectionalPort<decision_msgs::msg::CueArray>(
            "cues", "",
            "A working set cues to use to evaluate the alternatives"),
        });
  }
